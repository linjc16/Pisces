...
class FairseqTask(object):
    ...
    def get_batch_iterator_imbalanced(
        self,
        dataset,
        max_sentences=None,
        max_positions=None,
        ...
        """
        Get an iterator that yields batches of data from the given imbalanced dataset.
        ...
        batch_sampler = dataset.batch_by_weight(
            indices,
    ...
    def get_batch_iterator(
        ...
        batch_sampler = dataset.batch_by_size(
            ...
            max_sentences=max_sentences, # batch size
            required_batch_size_multiple=required_batch_size_multiple,
        )
