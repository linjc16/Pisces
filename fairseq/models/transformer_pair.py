...
class TransformerPairEncoder(FairseqEncoder):
    ...
    def __init__(self, args, dictionary, embed_tokens):
        ...
        if args.cross_encoder_normalize_before:
            self.cross_layer_norm = LayerNorm(embed_dim)
        else:
            self.cross_layer_norm = None
    ...
    def forward_scriptable(
        ...
        if self.cross_layer_norm is not None:
            src_x = self.cross_layer_norm(src_x)
            tgt_x = self.cross_layer_norm(tgt_x)
