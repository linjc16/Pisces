...
from const_leave_comb import SYNERGY_FILE, DRUG2ID_FILE, DRUG_FEAT_FILE, CELL_FEAT_FILE, CELL2ID_FILE, OUTPUT_DIR
...
def step_batch_eval(model, batch, gpu_id=None):
    ...
    return y_true, y_pred, torch.sigmoid(y_pred) > 0.3
