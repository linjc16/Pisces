...
for i in range(num_fold):
    ...
    data_train = pd.read_csv(f'baselines/DeepDDs-master/data_ours_leave_comb/train_fold{i}.csv')
    data_test = pd.read_csv(f'baselines/DeepDDs-master/data_ours_leave_comb/test_fold{i}.csv')
    data_valid = pd.read_csv(f'baselines/DeepDDs-master/data_ours_leave_comb/valid_fold{i}.csv')
    ...
    df_synergy.to_csv(f'baselines/PRODeepSyn-main/predictor/data_ours_leave_comb/synergy_fold{i}.tsv', sep='\t', index=False, header=True)
