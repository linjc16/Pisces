...
for i in range(5):
    ...
    for data_name in data_name_list:
        ...
        for a, b, cell, y in zip(tqdm(data['drug1_name']), data['drug2_name'], \
            ...
            drug1_feats.append(df_drug_fpts.loc[a].tolist() + df_drug_targets[df_drug_targets['drug_names'] == a].iloc[0, 1:].tolist())
            drug2_feats.append(df_drug_fpts.loc[b].tolist() + df_drug_targets[df_drug_targets['drug_names'] == b].iloc[0, 1:].tolist())
