...
from fairseq.models.transformer_pair import TransformerPairEncoder
...
class DrugTransformerConfig(FairseqDataclass):
    ...
    cross_encoder_normalize_before: bool = field(default=True)
...
@register_model("drug_pair_transfomer", dataclass=DrugTransformerConfig)
...
def base_architecture(args):
    ...
    args.cross_encoder_layers = getattr(args, "cross_encoder_layers", 1)
    args.encoder_attention_heads = getattr(args, "encoder_attention_heads", 4)

@register_model_architecture("drug_pair_transfomer", "drug_pair_transfomer_base")
def base_architecture(args):
    args.encoder_embed_dim = getattr(args, "encoder_embed_dim", 512)
    args.encoder_ffn_embed_dim = getattr(args, "encoder_ffn_embed_dim", 1024)
    args.encoder_layers = getattr(args, "encoder_layers", 4)
    args.cross_encoder_layers = getattr(args, "cross_encoder_layers", 2)
    args.encoder_attention_heads = getattr(args, "encoder_attention_heads", 4)

@register_model_architecture("drug_pair_transfomer", "drug_pair_transfomer_large")
