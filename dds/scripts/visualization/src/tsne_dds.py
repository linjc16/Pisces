...
tri_pair_feats = torch.load(os.path.join(root_dir, 'drug_triplets_DeepDDS.pt')).numpy()
labels = torch.load(os.path.join(root_dir, 'labels_DeepDDS.pt')).long().squeeze(1).numpy()
