...
ARCH=drug_dv_base
CLSHEAD=bclsmlpdvppiconsv4
CRITERION=binary_class_loss_bce_dv_v3
DATAFOLD=$1
LR=$2
CONS_ALPHA=$3
SCS_ALPHA=0.01
...
# SAVEDIR=/data/linjc/dds/ckpt_leave_cells/$TASK/$ARCH/$CRITERION/$DATAFOLD/$CLSHEAD/baseline_ljc_lr$LR-norm-drop$DROP-memory$MEMORY-alpha$CONS_ALPHA-scsalpha$SCS_ALPHA-v2.9-noSMcons-raw
DATADIR=/data/linjc/dds/data_new/leave_cells/$DATAFOLD/data-bin
SAVEDIR=/data/linjc/dds/ckpt_leave_cells_new/$TASK/$ARCH/$CRITERION/$DATAFOLD/$CLSHEAD/baseline_ljc_lr$LR-norm-drop$DROP-memory$MEMORY-alpha$CONS_ALPHA-scsalpha$SCS_ALPHA-v2.9-noSMcons-raw


CUDA_VISIBLE_DEVICES=1 python dds/src/binary_class_inf.py $DATADIR \
