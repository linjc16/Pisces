...
SAVEDIR=/data/linjc/dds/ckpt_leave_cells/$TASK/$ARCH/$CRITERION/$DATAFOLD/$CLSHEAD/baseline_ljc_lr$LR-norm-drop$DROP-memory$MEMORY-v2


CUDA_VISIBLE_DEVICES=0 python dds/src/binary_class_inf.py $DATADIR \
    --restore-file $SAVEDIR/checkpoint88.pt \
    --user-dir dds/src \
