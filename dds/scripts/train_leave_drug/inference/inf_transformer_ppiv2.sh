...
DATADIR=/data/linjc/dds/data/leave_drugs/$DATAFOLD/data-bin
SAVEDIR=/data/linjc/dds/ckpt_leave_drugs/$TASK/$ARCH/$CRITERION/$DATAFOLD/$CLSHEAD/baseline_ljc_lr$LR-norm-drop$DROP-memory$MEMORY-maxmean


CUDA_VISIBLE_DEVICES=3 python dds/src/binary_class_inf.py $DATADIR \
