...
DATADIR=/data/linjc/dds/data_new/leave_combs/$DATAFOLD/data-bin
SAVEDIR=/data/linjc/dds/ckpt_leave_combs_new/$TASK/$ARCH/$CRITERION/$DATAFOLD/$CLSHEAD/baseline_ljc_lr$LR-norm-drop$DROP-memory$MEMORY-alpha$CONS_ALPHA-scsalpha$SCS_ALPHA-v2.9-noSMcons-raw
