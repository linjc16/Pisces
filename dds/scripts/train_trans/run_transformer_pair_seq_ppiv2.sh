...
ARCH=drug_pair_transfomer_seq_tiny
...
SAVEDIR=/data/linjc/dds/ckpt/$TASK/$ARCH/$CRITERION/$DATAFOLD/$CLSHEAD/baseline_ljc_lr$LR-norm-drop$DROP-memory$MEMORY-v5
...
CUDA_VISIBLE_DEVICES=7 python dds/src/train.py $DATADIR \
    ...
    --warmup-updates 7000 --total-num-update 200000  --max-update 200000 \
