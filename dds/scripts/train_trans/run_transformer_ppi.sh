...
DATADIR=/data/linjc/dds/data/transductive_3fold/$DATAFOLD/data-bin
SAVEDIR=/data/linjc/dds/ckpt_3fold/$TASK/$ARCH/$CRITERION/$DATAFOLD/$CLSHEAD/baseline_ljc_lr$LR-norm-drop$DROP
